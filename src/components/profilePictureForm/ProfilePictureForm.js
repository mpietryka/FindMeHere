...
export const ProfilePictureForm = ({currentUser, image, avatar, handleImageChange, handleSubmit}) => {
  return (
    ...
    <div>
      ...
      <div className="mx-auto w-3/4">
        ...
        <button className="btn btn-primary w-full rounded-md text-white" onClick={handleSubmit}>
          <span>Submit</span>
        </button>
      </div>
    </div>
